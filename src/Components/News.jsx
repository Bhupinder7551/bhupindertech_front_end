...
function News(props) {
  const articles = [
    {
      ...
      publishedAt: "2017-08-26T11:40:16+00:00",
      content:
    ...
    },
    {
      ...
      publishedAt: "2019-04-27T11:41:47Z",
      content:
    ...
    },
    {
        ...
        publishedAt: "2022-05-11T15:26:05Z",
        content:
  ...
  return (
    <div className="news">
 <h1>Latest News Top headlines <button className="btn"  data-toggle="modal" data-target="#exampleModalCenter">
...
<div className="modal fade" id="exampleModalCenter" tabIndex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div className="modal-dialog modal-dialog-centered" role="document">
    <div className="modal-content">
      <div className="modal-header">
        <h5 className="modal-title text-dark" id="exampleModalLongTitle">Modal title</h5>
        <button type="button" className="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div className="modal-body text-dark">
     Data get from api all the latest news 
      </div>
      ...
      <div className="d-flex justify-content-evenly newscard">
        {articles.slice(0,4).map((e) => {
          let yearDiff =  new Date().getFullYear() -  new Date(e.publishedAt).getFullYear();
          let monthdiff = new Date().getMonth() - new Date(e.publishedAt).getMonth();
          ...
          return (
            <div className="card" key={e.url}>
              {yearDiff <= 0 && monthdiff<=1? (
                <span className="position-absolute top-0 start-100  badge ">
                  <p>New</p>
                </span>
              ) : (
                ""
              ...
              <div className="card-body">
                ...
                <small className="text-muted"> {e.author ? e.author: ""}</small><br/>
                <p className="card-text-date">
                  <small className="text-muted"> {new Date(e.publishedAt).toGMTString()}</small>
                </p>
                <a href={e.url} target="_blank" type="button">
                  Read More
                </a>
              </div>
            </div>
 ...
 <button className="btn"  data-toggle="modal" data-target="#exampleModalCenter">All News</button>
    </div>
  );
}
News.defaultProps = {
